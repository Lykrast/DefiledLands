...
public class DungeonDefiledList {
	//Everything is copied from net.minecraftforge.common.DungeonHooks since it uses static stuff so we can have our own
    ...
    {
    	return addDungeonMob(new ResourceLocation(DefiledLands.MODID, name), rarity);
    }
