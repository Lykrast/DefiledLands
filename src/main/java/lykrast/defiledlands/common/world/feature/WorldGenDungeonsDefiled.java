...
public class WorldGenDungeonsDefiled extends WorldGenerator {
	...
	public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        if (j2 >= 1 && j2 <= 5)
        {
                ...
                for (int j4 = 0; j4 < 3; ++j4)
                {
                    ...
                    if (worldIn.isAirBlock(blockpos2))
                    {
                        ...
                        if (j3 == 1)
                        {
                            ...
                            {
                                ((TileEntityChest)tileentity1).setLootTable(LOOT, rand.nextLong());
                            }
            ...
            (new WorldGenScuronotte()).generate(worldIn, rand, position);
    ...
    {
        return DungeonDefiledList.getRandomDungeonMob(rand);
    }
